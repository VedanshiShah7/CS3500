...
public class AnimationSVGView implements AnimatorView {
  ...
  public void makeVisible() {
    throw new UnsupportedOperationException("This is SVG representation");
  }
  ...
  private void createSVGMotion(AnimatorCommand a, ShapesModel s) {
    if (s instanceof Rectangle) {
