...
public class RectangleTest {
  ...
  public void testGetDistinctCommand() {
    ...
    assertEquals(new ArrayList<ChangeColor>(Arrays.asList((ChangeColor) c2)),this.r1.getColorCommands());
    assertEquals(new ArrayList<ChangeSize>(Arrays.asList((ChangeSize) c3)),this.r1.getSizeCommands());
